...
import 'package:vidhaan_school_app/report_card/Report%20Card%20Print.dart';
import '../notification_controllers/Notifications.dart';
import '../attendance/StudentAttendance_Page.dart';
import '../profile/Student_Profile.dart';
import '../exam/StudentsExam.dart';
import '../notification_controllers/Studnet_Notification_Page.dart';
import '../accounts/account_page.dart';
import '../assignments/assignmentsdetailsst.dart';
...
bool Loading=false;
  ...
  checkversion(NewVersionPlus newVersion)async{
    ...
    if (status != null) {
      ...
      if(status.storeVersion != status.localVersion){
        newVersion.showUpdateDialog(
            ...
            dialogText: 'Kindly install the updated version',
  ...
  void initState() {
    ...
    _pageController = PageController();    final newVersion = NewVersionPlus(
        androidId: "info.socorp.vidhaan"
    );
          ...
          children: [
            ...
            Stack(
              children: [
                ...
                Padding(
                  padding: EdgeInsets.only(top: height / 15.2),
                  child: Container(
