...
class Constants {
  ...
  Constants(String schoolID) {
    ...
    else if (schoolID == "VDAV") {
      FirebaseApp _fifthApp = Firebase.app('FifthApp');
      _firestore2db = FirebaseFirestore.instanceFor(app: _fifthApp);
      _firestorage2db = FirebaseStorage.instanceFor(app: _fifthApp);
      _firebaseauth2db = FirebaseAuth.instanceFor(app: _firstApp);
    }
