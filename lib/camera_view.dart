...
class _CameraViewState extends State<CameraView> {
  ...
  Widget _backButton() => Positioned(
    ...
    child: SizedBox(
      ...
      child: FloatingActionButton(
        heroTag: Object(),
        onPressed: () {
          print("Camera dessssssssssssssssssssssssssssssssssssssssssss");
          print(_controller!.cameraId);
  ...
  void _processCameraImage(CameraImage image) {
    ...
    print(inputImage.inputImageData.toString());
    _processImage(inputImage);
    print("sdgtfffffffffffffffffffffffffffffffffffffffffffffffffff");
  }
    ...
    return InputImage.fromBytes(
     ...
     inputImageData: InputImageData(
      ...
      size: Size(image.width.toDouble(), image.height.toDouble()),
       imageRotation: rotation, planeData: [], // used only in iOS
    ),
    );
  }
}