...
//   String schoolId;
//   String ?Feestitle;
//    Fees_details_Page(this.Studentdocid,this.Feestitle, this.schoolId);
//
//   @override
...
//                  ),
//                  StreamBuilder(
//                      stream: constants.firestore2db?.collection("Students").doc(widget.Studentdocid).collection("Fees").where("status",isEqualTo: false).snapshots(),
